...
The online person or the original version i took inspiration from - http://en.battleship-game.org/
...
Smart collision + boundary detection
...
Factory functions (Ship, Player, Gameboard)

DOM + logic separation
